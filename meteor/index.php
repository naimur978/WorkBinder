                ...
                <div class="cd-full-width">
                    <div class="tm-slide-content-div slide-caption">
                        ...
                        <div class="primary-button">
                            <a href="browse-jobs.php">Discover Jobs</a>
                        </div>
                    </div>
                </div> <!-- .cd-full-width -->
            </li>
                ...
                <div class="projects-holder-3">
                    <div class="filter-categories">
                        <ul class="project-filter">
                            ...
                            <li class="filter" data-filter="nature"><span>Notes Writing</span></li>
                            <li class="filter" data-filter="tuition"><span>Tuition</span></li>
                            <li class="filter" data-filter="workspace"><span>Designing</span></li>
                            <li class="filter" data-filter="city"><span>Data Entry</span></li>
                            <li class="filter" data-filter="technology"><span>Admission Form Fill-Up</span></li>
                        </ul>
                    </div>
                    <div class="projects-holder">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 project-item mix tuition">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="img/portfolio_11.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="img/portfolio_big_05.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
    ...
    <div id="contact" class="page-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14759.860404226247!2d91.82942631811049!3d22.354946559867642!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30acd89e1a92c4b9%3A0xa6819d9009884ddb!2z4Kaa4KaVIOCmrOCmvuCmnOCmvuCmsCwg4Kaa4Kaf4KeN4Kaf4KaX4KeN4Kaw4Ka-4Kau!5e0!3m2!1sbn!2sbd!4v1563721682733!5m2!1sbn!2sbd" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form id="task-form">
                  ...
                  <div class="form-group">
                    <textarea id="description" cols="30" rows="10" class="form-control" placeholder="Problem Description"></textarea>
                  </div>
